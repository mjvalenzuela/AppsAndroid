...
public class PlayActivity5 extends AppCompatActivity {
    ...
    public void numAleatorio (){
        if(puntaje <= 49){ //Valida que el puntaje sea menor a 50 para seguir en el mismo nivel
            ...
            Intent siguiente = new Intent(this,PlayActivity6.class);

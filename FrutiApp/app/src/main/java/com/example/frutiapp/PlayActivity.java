...
public class PlayActivity extends AppCompatActivity {
    ...
    public void numAleatorio (){
        if(puntaje <= 9){ //Valida que el puntaje sea menor a 10 para seguir en el mismo nivel
            numAleatorio1 = (int) (Math.random()*10);
            numAleatorio2 = (int) (Math.random()*10);

            resultado = numAleatorio1+numAleatorio2;

            if(resultado <= 10){ //Valida que las sumas no sean mayores a 10
                ...
                numAleatorio(); //Se debe ejeutar nuevamente hasta que el resultado sea menor o igual a 10
            }
        } else {
            Intent siguiente = new Intent(this,PlayActivity2.class);
            string_puntaje = String.valueOf(puntaje);
            string_vidas = String.valueOf(vidas);
            siguiente.putExtra("jugador",nombre_jugador);
            siguiente.putExtra("puntaje",string_puntaje);
            siguiente.putExtra("vidas",string_vidas);

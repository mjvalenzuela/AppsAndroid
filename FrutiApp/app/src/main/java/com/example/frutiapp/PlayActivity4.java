...
public class PlayActivity4 extends AppCompatActivity {
    ...
    public void numAleatorio (){
        if(puntaje <= 39){ //Valida que el puntaje sea menor a 40 para seguir en el mismo nivel
            numAleatorio1 = (int) (Math.random()*10);
            numAleatorio2 = (int) (Math.random()*10);

            if(numAleatorio1>=0 && numAleatorio1<=4){
            ...
            Intent siguiente = new Intent(this,PlayActivity5.class);
